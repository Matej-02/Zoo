...
with sync_playwright() as p:
    ...
    check('Older saves migrate to new care, event and panel state', migration_result['version']==8 and migration_result['waste'] and migration_result['events'] and migration_result['care'] and migration_result['panel'], str(migration_result))
