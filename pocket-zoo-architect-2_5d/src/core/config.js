...
const SAVE_KEY = 'pocketZooArchitectSaveV7';

const OLD_KEYS = ['pocketZooArchitectSaveV6', 'pocketZooEvolutionSaveV4', 'pocketZooUltimateSaveV3', 'pocketZooDeluxeSaveV2', 'pocketZooSave'];
